...
python run_easter_inference.py --input_dir "Output" --iiif_manifest "https://iiifpres.bdrc.io/vo:bdr:I1KG81132/manifest" --line_model "Models\LineModels\khyentse_wangpo_q.onnx" --ocr_model "Models\OCRModels\khyentse_wangpo_easter.hdf5"
...
if __name__ == "__main__":
    ...
    if os.path.isfile(args.line_model) and os.path.isfile(args.ocr_model):
        ...
        pipeline.run(input_dir, output_formats=["xml", "prodigy", "text"])
